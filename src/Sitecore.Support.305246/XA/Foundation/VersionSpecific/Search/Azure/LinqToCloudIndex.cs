// --------------------------------------------------------------------------------------------------------------------
// <copyright file="LinqToCloudIndex.cs" company="Sitecore Corporation A/S">
//     © 2016 Sitecore Corporation A/S. All rights reserved.
// </copyright>
// <summary>
//     Defines the LinqToCloudIndex type.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
using CloudQueryMapper = Sitecore.XA.Foundation.Search.Providers.Azure.CloudQueryMapper;
...
namespace Sitecore.Support.XA.Foundation.VersionSpecific.Search.Azure
{
    public class LinqToCloudIndex<TItem> : ContentSearch.Azure.Query.LinqToCloudIndex<TItem>
    {
        ...
        protected CloudSearchSearchContext Context { get; }
        ...
        public LinqToCloudIndex(CloudSearchSearchContext context, IExecutionContext executionContext) : base(context, executionContext)
        {
            ...
            QueryMapper = new CloudQueryMapper(parameters);
        ...
        public LinqToCloudIndex(CloudSearchSearchContext context, IExecutionContext[] executionContexts, ServiceCollectionClient client) : base(context, executionContexts, client)
        {
            ProviderIndexConfiguration config = context.Index.Configuration;
